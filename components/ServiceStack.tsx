...
const services = [
  {
    ...
    alt: "Embedded software delivery: an open book releasing a column of blue data",
  ...
  },
  {
    ...
    alt: "Modernisation and AI integration: a blue topographic mesh rising from a white field",
  ...
  },
  {
    ...
    alt: "Technical due diligence: a surveying instrument in motion blur",
